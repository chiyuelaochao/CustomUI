...
public class SaveRestoreBasicView extends View {
    private final String TAG = getClass().getSimpleName();

    public SaveRestoreBasicView(Context context) {
        this(context, null);
    }

    public SaveRestoreBasicView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

...
public class SpiderWebRadarView extends View {
    ...
    public SpiderWebRadarView(Context context) {
        this(context, null);
    }

    public SpiderWebRadarView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

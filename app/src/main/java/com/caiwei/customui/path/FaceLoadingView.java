...
public class FaceLoadingView extends View {
    ...
    /**
     * 嘴巴左边跟右边距离top的距离（控件的高度＊MOUTH_PERCENT_H）
     */
    private static final float MOUTH_PERCENT_H = 0.55F;
    /**
     * 嘴巴中间距离top的距离（控件的高度＊MOUTH_PERCENT_H2）
     */
    private static final float MOUTH_PERCENT_H2 = 0.7F;
    /**
     * 嘴巴左边跟右边距离边缘的位置（控件宽度＊MOUTH_PERCENT_W）
     */
    private static final float MOUTH_PERCENT_W = 0.23F;
    /**
     * 眼睛跟嘴巴摆动的区间范围
     */

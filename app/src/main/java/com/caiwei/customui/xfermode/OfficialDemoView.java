...
public class OfficialDemoView extends View {
    ...
    public OfficialDemoView(Context context) {
        super(context);
        init(null, 0);
    }

    public OfficialDemoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public OfficialDemoView(Context context, AttributeSet attrs, int defStyle) {

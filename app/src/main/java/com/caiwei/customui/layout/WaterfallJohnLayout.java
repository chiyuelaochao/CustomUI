...
public class WaterfallJohnLayout extends ViewGroup {
    ...
    public WaterfallJohnLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mTop = new int[mColumns];
    }

    public WaterfallJohnLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaterfallJohnLayout(Context context) {
        this(context, null);
    }
    ...
    private static class WaterfallLayoutParams extends ViewGroup.LayoutParams {
        private int left = 0;
        private int top = 0;
        private int right = 0;
        private int bottom = 0;

        private WaterfallLayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        private WaterfallLayoutParams(int width, int height) {
            super(width, height);
        }

        private WaterfallLayoutParams(android.view.ViewGroup.LayoutParams params) {
            super(params);
        }
